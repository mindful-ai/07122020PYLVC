...
class jumblegame(object):
    ...
    @jumble # --> use decorator functions discussed in decorators_ex
    ...
    def run(self):
        ...
        for word in self.data:
            ...
            # Pick a word
            # Jumble the word
            self.jword = self.modifystring(word)
    ...
    def results(self):
        ...
        print(self.name + " took " + str(self.timetaken.seconds) + " seconds to complete the game")
